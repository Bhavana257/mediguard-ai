    ...
    <div className="w-64 bg-white h-screen shadow-lg fixed left-0 top-0 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-800">MediGuard AI</h1>
      ...
      <nav className="flex-1 p-4 space-y-2">
        <a href="#" className="flex items-center space-x-3 px-4 py-3 bg-primary/10 text-primary rounded-lg font-medium">
